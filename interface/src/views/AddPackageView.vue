  ...
  >
    ...
    <form v-else class="space-y-6">
      ...
      <div class="form-control">
        ...
        <input
          type="text"
          v-model="addPackage.description"
...
export default {
  ...
  methods: {
    savePackage() {
      this.formErrors = {};
      this.message = null;
      PackagesDataService.create(this.addPackage)
        .then((response) => {
          this.addPackage.id = response.data.id;
          this.addPack(this.addPackage);
          this.submitted = true;
          this.message = `Forfait ajouté avec l'ID ${response.data.id}`;
        })
        .catch((error) => {
